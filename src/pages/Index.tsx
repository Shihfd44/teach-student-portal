    ...
    <div className="min-h-[calc(100vh-10rem)] flex flex-col items-center justify-center">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
          Образовательная платформа университета
        </h1>
        <p className="text-xl text-muted-foreground mb-8">
          Современная платформа для преподавателей, создающих тесты, и студентов, стремящихся к улучшению своих знаний.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto px-4">
        <AnimatedCard delay={1} className="text-center">
          ...
          <p className="text-muted-foreground">Доступ к тестам, просмотр прогресса и улучшение академической успеваемости.</p>
        </AnimatedCard>
        ...
        <AnimatedCard delay={2} className="text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">Для преподавателей</h3>
          <p className="text-muted-foreground">Создание тестов, оценка знаний студентов и отслеживание успеваемости группы.</p>
        </AnimatedCard>
        ...
        <AnimatedCard delay={3} className="text-center">
          ...
          <p className="text-muted-foreground">Визуализация результатов обучения и выявление областей для улучшения.</p>
        </AnimatedCard>
      </div>
    </div>
  );
